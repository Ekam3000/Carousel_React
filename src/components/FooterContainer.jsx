                ...
                <div className="col-lg-12 d-none d-lg-block pt-5 ">
                    ...
                    <div className="row ">
                        ...
                        <div className="col-7 " style={{ color: '#425656' }}>
                            <div className="row">
                            <div className="col "><a href="#" style={{textDecoration: 'none', color: '#425656'}}>Contact Us</a></div>
                            <div className="col"><a href="#" style={{textDecoration: 'none', color: '#425656'}}>Privacy and Cookies</a></div>
                            <div className="col"><a href="#" style={{textDecoration: 'none', color: '#425656'}}>Trademarks</a></div>
                            <div className="col"><a href="#" style={{textDecoration: 'none', color: '#425656'}}>About our ad</a></div>
