        ...
        <div className="three-box text-start p-4">
          <div className="row gx-5">
            <div className="col-sm">
              <div className="bg-light p-3" id="day" style={{ height: '100%' }}>
            ...
            <div className="col-sm">
              <div className="bg-light p-3" id="month" style={{ height: '100%' }}>
            ...
            <div className="col-sm">
              <div className="bg-light p-3" id="year" style={{ height: '100%' }}>
